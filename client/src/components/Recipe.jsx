...
import img2 from "./Styles/Heart.png";
...
export default function Recipe(props) {
  ...
  return (
    <div className={style.general}>
      <Link to={`/home/${id}`}>
        {image ? (
          <img className={style.img} src={image} alt="Img Not Found."></img>
        ) : (
          <img
            className={style.img}
      ...
      <div>
        {stars === 1 ? (
          <img className={style.star} src={img} alt="Img Not Found."></img>
        ) : stars === 2 ? (
          <div>
            <img className={style.star} src={img} alt="Img Not Found."></img>{" "}
            <img className={style.star} src={img} alt="Img Not Found."></img>
      ...
      <div>
        ...
        {diets?.map((d) => {
          if (d.hasOwnProperty("name")) {
            ...
            return <p key={prevId++}>- {d[0].toUpperCase() + d.slice(1)} </p>;
          }
        })}
      </div>
    </div>
